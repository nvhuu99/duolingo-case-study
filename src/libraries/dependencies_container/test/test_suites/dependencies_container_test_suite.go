...
import (
	...
	"duolingo/libraries/dependencies_container/test/fake"

	"github.com/google/uuid"
	"github.com/stretchr/testify/suite"
)

type DependenciesContainerTestSuite struct {
	suite.Suite
}

func (s *DependenciesContainerTestSuite) SetupSuite() {
	container.Init(context.Background())
}

func (s *DependenciesContainerTestSuite) Test_Bind_Alias_Transient() {
...
func (s *DependenciesContainerTestSuite) Test_Bind_Alias_Singleton() {
...
func (s *DependenciesContainerTestSuite) Test_Bind_Transient() {
...
func (s *DependenciesContainerTestSuite) Test_Bind_Singleton() {
...
func (s *DependenciesContainerTestSuite) Test_Bind_Concrete() {
...
func (s *DependenciesContainerTestSuite) Test_Bind_Mismatch() {
	// mismatch pointer
