  ...
  <div id="services-metric-section">
    <div class="card shadow-sm p-4">
      <div class="mb-4 d-flex align-items-center">
        <h5 class="m-0 me-4" style="font-size: 16px"> Services Metric </h5>
      ...
      <div class="services-selection input-group mb-4">
        <button class="col-4 btn btn-lg btn-dark rounded-0 fs-6">CPU stats</button>
        <button class="col-4 btn btn-lg btn-outline-dark rounded-0 fs-6">Memory stats</button>
        <button class="col-4 btn btn-lg btn-outline-dark rounded-0 fs-6">Disks IO stats</button>
      </div>
